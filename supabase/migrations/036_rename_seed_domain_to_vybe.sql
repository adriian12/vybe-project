-- ============================================================================
-- 036 · La marca pasa a llamarse Vybe
--
-- Las cuentas del seed de Mallorca cambian de `@seed.vybes.test` a
-- `@seed.vybe.test`, y la sala de pruebas se busca por el correo nuevo. La
-- función es la misma de la 035; sólo cambia el dominio.
--
-- Los datos ya cargados se renombran aparte, con
-- `supabase/seeds/rename_seed_to_vybe.sql`.
-- ============================================================================
...
BEGIN
    ...
    WHERE v.email = 'sala-pruebas@seed.vybe.test';
    ...
    WHERE ea.event_id = v_event.id AND p.email LIKE '%@seed.vybe.test';
