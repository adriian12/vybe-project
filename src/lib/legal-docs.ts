...
const ALIASES: Record<string, LegalDocId> = {
  ...
  'condiciones-para-negocios': 'venues',
 ...
 * @param panel La web de negocios y administración.
  ...
  return [
    // ------------------------------------------------------------ privacidad
    {
      ...
      sections: [
        ...
        },
        {
          ...
          body: `Para crear y mantener tu cuenta; comprobar que estás en la fiesta; enseñarte a otras personas de la misma fiesta si entras como ${miembro} y permitir el chat cuando hay match; gestionar las entradas, los vales, las listas de invitados y las suscripciones que contratas; mandarte los avisos que activas (fiestas nuevas de los negocios que sigues, que empieza una fiesta a la que vas, mensajes y matches); atender las alertas de ayuda; moderar la plataforma y prevenir abusos; y elaborar estadísticas agregadas para los negocios.`,
        },
        {
          title: 'Base legal',
        ...
        {
          title: 'Ubicación',
          body: 'Sólo usamos tu ubicación con la app abierta y para comprobar que estás dentro del radio de la fiesta al entrar. No la compartimos con otras personas: como mucho, una distancia aproximada. Si pides ayuda con el botón de emergencia, tu ubicación de ese momento llega al personal del negocio y a los contactos de confianza que hayas elegido. Puedes quitar el permiso desde los ajustes del teléfono o del navegador.',
        },
        {
      ...
      sections: [
        {
          ...
          body: `${app} es una aplicación para descubrir fiestas y vivirlas: ver qué hay, decir que vas, entrar con el código del negocio y, si quieres, conocer a otras personas que están en la misma fiesta. El titular es ${titular}.`,
        },
        {
          title: 'Requisitos',
        ...
        },
        {
          ...
          body: `Como invitado ves las fiestas, las ofertas, los sorteos y los avisos de los negocios. Como ${miembro}, además, haces la foto del momento, apareces en el tablón de la fiesta y puedes hacer match, participar en sorteos y retos y votar canciones. Puedes cambiar de modo con los límites que indica la app.`,
        },
        {
          title: 'Normas de conducta',
          body: 'No se permite el acoso, el contenido sexual explícito, la violencia, el odio, suplantar a otra persona, la publicidad no autorizada, pedir dinero ni usar la app para actividades ilegales. Tampoco hacer mal uso del botón de ayuda. Si alguien incumple estas normas puedes denunciarlo desde su perfil. Podemos suspender o eliminar cuentas, y el negocio puede retirar el acceso a una fiesta, sin aviso previo cuando haya un incumplimiento.',
        },
        {
          title: 'Seguridad',
          body: 'No comprobamos los antecedentes de nadie. Queda en lugares públicos, avisa a alguien de confianza y usa el botón de ayuda si te sientes en peligro: avisa al negocio y a tus contactos de confianza. En una emergencia, llama al 112.',
        },
        {
          title: 'Tu contenido',
        ...
        {
          title: 'Fiestas, negocios y listas de invitados',
          body: `Las fiestas las organizan los negocios, que responden de lo que publican: horarios, precios, aforo, edad mínima, normas de acceso, ofertas y premios. ${app} no organiza las fiestas ni garantiza que se celebren. Apuntarte a una lista de invitados no asegura la entrada: el negocio decide en la puerta.`,
        },
        {
          title: 'Compras',
        ...
        },
        {
          ...
          body: 'Prestamos el servicio con diligencia, pero no garantizamos que esté disponible sin interrupciones. No respondemos de lo que pase en los encuentros entre personas ni de lo que hagan los negocios en sus fiestas, salvo en lo que la ley no permita excluir.',
        },
        {
          title: 'Baja',
    ...
    // ---------------------------------------------------------------- cookies
    {
      ...
      sections: [
        {
          title: 'Qué son',
          body: 'Las cookies y tecnologías parecidas (almacenamiento negocio del navegador o de la app) son pequeños datos que una web o una app guarda en tu dispositivo.',
        },
        {
          title: 'Qué usamos',
          body: `Sólo almacenamiento técnico, necesario para que ${app} funcione: la sesión iniciada (para no pedirte la contraseña cada vez), el idioma que eliges, la sección abierta del panel de negocios y los ficheros de la web guardados por el navegador para que cargue rápido. En la app instalada, la sesión se guarda en el almacenamiento seguro del teléfono.`,
        },
        {
          title: 'Qué no usamos',
    ...
    // ------------------------------------------------------------ aviso legal
    {
      ...
      sections: [
        ...
        },
        {
          ...
          body: `La marca ${app}, el logotipo, el diseño y el código de la web y de la app son del titular o se usan con permiso. No se pueden copiar, distribuir ni modificar sin autorización. Los carteles, nombres y logotipos de los negocios y de sus fiestas son de sus titulares.`,
        },
        {
          title: 'Enlaces',
          body: 'Los enlaces a webs de terceros (negocios, venta de entradas, Stripe…) se ofrecen como ayuda; no respondemos de su contenido.',
        },
        {
          title: 'Ley aplicable',
    ...
    // ---------------------------------------------------------------- negocios
    {
      id: 'venues',
      slug: 'negocios',
      title: 'Condiciones para negocios',
      summary: 'Alta, planes, cobros con Stripe, comisiones, equipo y responsabilidades de los negocios.',
      sections: [
        {
        ...
        {
          title: 'Planes',
          body: 'Hay un plan gratuito y dos de pago (Pro y Business), con las funciones y límites que se ven en el panel, en Plan. Los planes de pago se cobran por meses y se renuevan solos hasta que se cancelan; al cancelar, el plan sigue hasta el final del periodo pagado y después el negocio vuelve al plan gratuito.',
        },
        {
        ...
        {
          title: 'Equipo',
          body: 'El propietario puede dar acceso con cuenta a otros propietarios y a seguridad, y crear enlaces sin cuenta para seguridad, camareros y relaciones públicas. El negocio responde del uso que su equipo haga de esos accesos y debe revocarlos cuando una persona deje de trabajar con él.',
        },
        {
        ...
        },
        {
          ...
          body: 'El negocio responde de que sus fiestas, carteles, ofertas, sorteos y premios sean veraces y legales, de tener las licencias necesarias, de respetar el aforo y la edad mínima, y de custodiar sus códigos de acceso.',
        },
        {
          title: 'Baja',
          body: `El negocio puede darse de baja cuando quiera escribiendo a ${correo}. Podemos suspender una cuenta que incumpla estas condiciones o la ley.`,
        },
      ],
    },
    ...
    // --------------------------------------------------------- eliminar cuenta
    {
      ...
      sections: [
        ...
        },
        {
          ...
          body: 'Los pedidos de entradas se quedan en las ventas del negocio, sin tu nombre. Los justificantes de pago los conserva Stripe durante el plazo que exige la ley (hasta seis años), bloqueados y sin usarlos para nada más. Las estadísticas agregadas de los negocios no te identifican.',
        },
        {
    ...
    // ---------------------------------------------------------------- soporte
    {
      ...
      sections: [
        ...
        },
        {
          ...
          body: 'Usa el botón de ayuda de la app: avisa al momento al personal del negocio y a tus contactos de confianza. Si hay peligro, llama al 112.',
        },
        {
          title: 'Denunciar a alguien',
          body: 'Con la opción «Denunciar» de su tarjeta en el tablón, de su perfil o del chat. Lo revisamos y, si hace falta, el negocio puede retirarle el acceso a la fiesta.',
        },
        {
          title: 'Pagos y entradas',
          body: `Para devoluciones de entradas, habla con el negocio que organiza la fiesta. Para Premium, supercrush o un cargo que no reconoces, escribe a ${correo} con el correo del justificante.`,
        },
        {
          title: 'Negocios',
          body: `Si tienes un negocio y quieres usar ${app}, pide una demo en ${dominio} o escribe a ${correo}.`,
        },
      ],
    },
  ];
